...
export const filterStyles = {
  ...
  earlyShieldLink:      { text: "#FFFFFF", background: "#281400", border: "#FF4400", size: 40 },
  earlyShieldBase:      { text: "#FFFFFF", background: "#000000", border: "#FF4400", size: 40 },
  momentum:             { text: "#FFA500", background: "#320000", border: "#FF0000", size: 45 },
  twoLink:              { text: "#FFC800", background: "#000000", border: "#FFC800", size: 40 },
