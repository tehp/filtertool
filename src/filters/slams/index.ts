...
## Other 4 Links
${rule().linkedSockets("==", 4).areaLevel("<=", 53).icon("Cyan", "Diamond").style(STYLE.E).size(40).compile()}
...
# Good 3 Sockets
${rule().sockets("==", 3).itemClass("Helmets", "Body Armours", "Gloves", "Boots").socketGroup(">=", "RG", "GR", "GG", "RR").areaLevel("<=", 33).border(255, 0, 127).compile()}
